...
static const char   *g_pszDefDmiBIOSVendor      = "American Megatrends International, LLC.";
static const char   *g_pszDefDmiBIOSVersion     = "UX5504VA.304";
static const char   *g_pszDefDmiBIOSReleaseDate = "06/04/2024";
/* type 1 -- DMI system information */
static const char   *g_pszDefDmiSystemVendor    = "ASUSTeK COMPUTER INC.";
static const char   *g_pszDefDmiSystemProduct   = "Zenbook UX5504VA";
...
static const char   *g_pszDefDmiSystemFamily    = "Zenbook";
/* type 2 -- DMI board information */
static const char   *g_pszDefDmiBoardVendor     = "ASUSTeK COMPUTER INC.";
static const char   *g_pszDefDmiBoardProduct    = "UX5504VA";
...
static const char   *g_pszDefDmiChassisVendor   = "ASUSTeK COMPUTER INC.";
static const int32_t g_iDefDmiChassisType       = 0x0A; /* Notebook */
...
static const char   *g_pszDefDmiProcManufacturer= "AuthenticAMD";
static const char   *g_pszDefDmiProcVersion     = "AMD Ryzen 7 5800H with Radeon Graphics";
...
void FwCommonPlantMpsTable(PPDMDEVINS pDevIns, uint8_t *pTable, unsigned cbMax, uint16_t cCpus)
{
    ...
    memcpy(pCfgTab->au8OemId, "ALASKA  ", 8);
    memcpy(pCfgTab->au8ProductId, "UX5504VA    ", 12);
