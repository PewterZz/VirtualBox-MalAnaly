...
char vbebios_copyright[]        = "VESA BIOS";
char vbebios_vendor_name[]      = VBOX_VENDOR;
char vbebios_product_name[]     = "Generic VBE Adapter";
char vbebios_product_revision[] = "Generic VBE Version " VBOX_VERSION_STRING;

char vbebios_info_string[]    = "VBE Display Adapter enabled\r\n\r\n";
char no_vbebios_info_string[] = "No VBE support available!\r\n\r\n";

#ifdef VGA_DEBUG
char msg_vbe_init[] = "Version " VBOX_VERSION_STRING " VBE Display Adapter\r\n";
#endif
