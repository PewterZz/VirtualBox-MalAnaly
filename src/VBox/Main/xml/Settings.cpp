                                ...
                                settings::Medium &med)
{
    ...
    while (llElementsTodo.size() > 0)
    {
        ...
        settings::Medium *pMed = llSettingsTodo.front();
        ...
        while ((pelmHDChild = nl2.forAllNodes()))
        {
            ...
            pMed->llChildren.push_back(settings::Medium::Empty);
                                 ...
                                 const settings::Medium &med)
{
    ...
    {
        const settings::Medium *pMed = llSettingsTodo.front();
        llSettingsTodo.pop_front();
