   ...
   public function checkClExe(strClExe)
      ...
      if rcExit = 0 then
         ...
         elseif InStr(1, strVer, "19.2") = 1 then
            m_strVersion = "VCC142"
         elseif InStr(1, strVer, "19.3") = 1 _
             or InStr(1, strVer, "19.4") = 1 then
            m_strVersion = "VCC143"
         else
            LogPrint "The Visual C++ compiler we found ('" & strClExe & "') isn't in the 10.0-19.4x range (" & strVer & ")."
...
sub CheckForQt(strOptQt, strOptInfix)
   ...
   if strPathQt = "" then
      ...
      if     g_strVCCVersion = "VCC142" or g_strVCCVersion = "VCC141" or g_strVCCVersion = "" then
